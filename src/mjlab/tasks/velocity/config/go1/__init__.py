...
from .env_cfgs import (
  unitree_go1_flat_blind_env_cfg,
  unitree_go1_flat_env_cfg,
  unitree_go1_rough_blind_env_cfg,
...
register_mjlab_task(
  task_id="Mjlab-Velocity-Rough-Blind-Unitree-Go1",
  env_cfg=unitree_go1_rough_blind_env_cfg(),
  play_env_cfg=unitree_go1_rough_blind_env_cfg(play=True),
  rl_cfg=unitree_go1_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)

register_mjlab_task(
  task_id="Mjlab-Velocity-Flat-Blind-Unitree-Go1",
  env_cfg=unitree_go1_flat_blind_env_cfg(),
  play_env_cfg=unitree_go1_flat_blind_env_cfg(play=True),
  rl_cfg=unitree_go1_flat_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
